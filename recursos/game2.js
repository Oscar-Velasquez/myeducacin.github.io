...
const touchMove2 = (e) =>{
    if (moveElement2) {
        ...
        currentSelectedElement.parentElement.style.top = currentSelectedElement.parentElement.offsetTop - (initialY2 - newY) + "px";
        currentSelectedElement.parentElement.style.left = currentSelectedElement.parentElement.offsetLeft - (initialX2 - newX) + "px";
        initialX2 = newX;
        initialY2 = newY;
    }
};
...
const drop2 = (e) => {
    ...
    if(isTouchDevice2()) {
        ...
        if( initialX2 >= currentDropBound.left && 
            ...
            currentDrop.insertAdjacentHTML(
                "afterbegin", 
                `<img src= "../recursos/img/billetes/${currentElement2.id}.png">`
            );
            count2 += 1;
        }
    }else {
        ...
        if(draggedElementData === droppableElementData) {
            ...
            e.target.insertAdjacentHTML(
                "afterbegin", 
                `<img src="../recursos/img/billetes/${draggedElementData}.png">`
            );
            count2 += 1;
        }
    }
