...
const generateResponse = (chatElement) => {
    ...
    } else if (userMessageLC.includes("como puedo ahorrar") || userMessageLC.includes("consejos para ahorrar")) {
    ...
    } else if (userMessageLC.includes("como ganar monedas")|| userMessageLC.includes("como puedo ganar monedas")) {
            messageElement.textContent = "Para ganar monedas debes terminar un juego correctamente.";
    } else if (userMessageLC.includes("como cerrar sesión")|| userMessageLC.includes("cerrar sesion") || userMessageLC.includes("como se cierra la sesion")) {
    ...
    } else if (userMessageLC.includes("como funciona la pagina")|| userMessageLC.includes("para que sirve esta pagina")|| userMessageLC.includes("que hace la pagina")) {
    ...
    } else if (userMessageLC.includes("ayuda con los juegos") || userMessageLC.includes("ayuda")) {
