...
require_once('../private/Config.php'); // Incluye el archivo de configuración
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($correo_ingresado) || empty($contrasena_ingresada)) {
      ...
      $consulta = "SELECT * FROM usuarios WHERE email = '$correo_ingresado' AND passwords = '$contrasena_ingresada'";
